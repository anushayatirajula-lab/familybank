...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // Delete approved chores older than 30 days, but NEVER delete recurring templates
    // (templates have is_recurring = true AND parent_chore_id IS NULL — they generate daily instances)
